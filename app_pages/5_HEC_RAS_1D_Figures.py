...
Ported from the "HEC-RAS 1D Profile Plotter" ipywidgets GUI. Plots any
number of Velocity/WSE/Profile/Elevation scenarios, each with its own
Station column. (For a raw Station-vs-Elevation geometry plot instead,
see the separate [Cross Sections](/cross-sections) page.)
...
if "hec_df_raw" in st.session_state:
    ...
    if "hec_result" in st.session_state:
        ...
        render_chart_panel(fig, key_prefix="hec_chart", base_filename="hecras_1d_profile",
